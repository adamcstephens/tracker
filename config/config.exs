...
config :tracker,
  ...
  ash_domains: [Tracker.Nixpkgs, Tracker.Accounts, Tracker.Ingestion, Tracker.Notifications]
...
config :esbuild,
  ...
  tracker: [
    args:
      ~w(js/app.js js/ui.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
