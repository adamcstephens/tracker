...
config :zoneinfo, tzpath: System.get_env("TZDIR", "/usr/share/zoneinfo")
...
#
#     PHX_SERVER=true bin/tracker start
#
...
if config_env() == :prod do
  ...
  port = String.to_integer(System.get_env("PORT") || "6950")
